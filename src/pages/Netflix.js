  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        ...
        setMustWatchMovies(allMovies.slice(10, 20));
        setHighlyRatedMovies(allMovies.slice(20, 30));
        setMostViewedMovies(allMovies.slice(30, 40));
      } catch (error) {
        console.error(error);
      }
    };
    ...
    <HeroContainer>
      <div className='hero'>
        ...
        <img
          ...
          src='https://occ-0-2705-34.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABS6v2gvwesuRN6c28ZykPq_fpmnQCJwELBU-kAmEcuC9HhWX-DfuDbtA-bfo-IrfgNtxl0qwJJlhI6DENsGFXknKkjhxPGTV-qhp.jpg?r=608'
          alt='hero image'
        />
